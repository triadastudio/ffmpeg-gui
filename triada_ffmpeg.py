import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QFileDialog, QLabel, QComboBox, QLineEdit, QRadioButton
import ffmpeg
...
class FFmpegGUI(QWidget):
    ...
    def init_ui(self):
        ...
        layout.addWidget(QLabel('Encoding Quality (CRF)'))
        self.crf_input = QLineEdit()
        layout.addWidget(self.crf_input)
    ...
    def encode_video(self):
        ...
        if not video_file or not crf:
            return

        output_file = f"output_{codec}_{pix_fmt}.mkv"
